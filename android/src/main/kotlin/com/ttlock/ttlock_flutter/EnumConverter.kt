...
fun lockErrorRevert(error: LockError): TTLockError {
    return when(error) {
        ...
        LockError.LOCK_INIT_KEYBOARD_FAILED -> TTLockError.INIT_WIRELESS_KEYBOARD_FAILED
        ...
        LockError.DATA_ALREADY_EXIST -> TTLockError.RECORD_EXIST
        ...
        LockError.INIT_WIRELESS_KEYBOARD_FAILED -> TTLockError.INIT_WIRELESS_KEYBOARD_FAILED
